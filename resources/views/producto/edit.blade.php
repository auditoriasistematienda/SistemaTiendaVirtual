    ...
    <div class="form-group col-md-3">
        ...
        <div class="col-xl-5 col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="prod_nombre" class="form-control" maxlength="50" required value="{{$producto->prod_nombre}}">
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="form-group">
                <label for="">Abreviatura del Producto *</label>
                <input type="text" name="prod_nombre" class="form-control" maxlength="50" required value="{{$producto->prod_slug}}">
            </div>
        </div>
        <div class="col-xl-5 col-md-6">
            <div class="form-group">
                <label for="">Descripcion *</label>
                <input type="text" name="prod_nombre" class="form-control" maxlength="50" required value="{{$producto->prod_descripcion}}">
            </div>
        </div>
        <div class="col-xl-5 col-md-6">
            <div class="form-group">
                <label for="">Descripcion Corta del Producto *</label>
                <input type="text" name="prod_nombre" class="form-control" maxlength="50" required value="{{$producto->prod_extract}}">
            </div>
        </div>
        ...
        <div class="col-xl-5 col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="prod_nombre" class="form-control" maxlength="50" required value="{{$producto->prod_imagen}}">
            </div>
        </div>
        <div class="col-xl-2 col-md-3">
            <div class="form-group">
